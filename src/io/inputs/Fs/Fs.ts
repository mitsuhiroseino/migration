...
class Fs extends InputBase<Content, FsInputConfig, FsInputResult> {
   ...
   * @returns
   */
  read(params: IterationParams): AsyncIterable<InputReturnValue<any, PathInputResultBase>> {
   ...
   * @returns
   */
  copy(params: IterationParams): AsyncIterable<InputReturnValue<any, PathInputResultBase>> {
   ...
   * @returns
   */
  move(params: IterationParams): AsyncIterable<InputReturnValue<any, PathInputResultBase>> {
    return this._generateFsInputResult(params);
  }
